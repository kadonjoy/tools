...
int convertToYuyv(const unsigned char * src, unsigned char * dst, int width, int height);
...
//    int stride = ceil(width*1.25/8)*8;
    ...
    unsigned char * yuyvBuf = malloc(width * height * 2);
